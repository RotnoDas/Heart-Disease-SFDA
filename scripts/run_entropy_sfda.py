...
def main():
    ...
    for (
        ...
        # ------------------------------------------
        # Transform with SOURCE-fitted preprocessor
        # ------------------------------------------
        ...
        for fold, (
            ...
            print(
                "Mean probability:",
                f"{stats['mean_probability_before']:.4f}",
                "->",
                f"{stats['mean_probability_after']:.4f}",
            )
            ...
            print(
                "Mean confidence:",
                f"{stats['confidence_before']:.4f}",
                "->",
                f"{stats['confidence_after']:.4f}",
            )
    ...
    result_path = (
        RESULT_DIR
        / "entropy_crossfit_core8.csv"
    )

    fold_path = (
        RESULT_DIR
        / "entropy_fold_stats.csv"
    )
